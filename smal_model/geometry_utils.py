...
def main():
    ...
    output = kornia.geometry.angle_axis_to_rotation_matrix(input)#轴角 转 旋转矩阵
    input_rec = kornia.geometry.rotation_matrix_to_angle_axis(output)#旋转矩阵 转 轴角
    print('..................... 2 ....................')
    print("input:\n", input)
    print("input_rec:\n", input_rec)
